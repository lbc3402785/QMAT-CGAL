...
typedef CGAL::Point_2< CGAL::Cartesian<simple_numbertype> > Point_2;
typedef CGAL::Point_3< CGAL::Cartesian<simple_numbertype> > Point;
typedef CGAL::Vector_3< CGAL::Cartesian<simple_numbertype> > Vector_3;
typedef CGAL::Triangle_2< CGAL::Cartesian<simple_numbertype> > Triangle_2;
typedef CGAL::Line_2< CGAL::Cartesian<simple_numbertype> > Line_2;
using namespace std;
using namespace Wm4;
...
typedef simple_kernel::Plane_3 Plane;
